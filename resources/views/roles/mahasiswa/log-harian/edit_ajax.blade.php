...
@section('content')
    ...
    <div class="custom-form-container">
        ...
        <div class="info-box">
            <strong>Dibuat:</strong> {{ $log->created_at->format('d/m/Y H:i') }}<br>
            <strong>Terakhir diubah:</strong> {{ $log->updated_at->format('d/m/Y H:i') }}
        </div>
        ...
        <form id="form-log-harian" action="{{ route('mahasiswa.log-harian.update', $log->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="custom-form-group">
                ...
                <textarea class="custom-form-control @error('aktivitas') is-invalid @enderror" 
                          ...
                          required>{{ old('aktivitas', $log->aktivitas) }}</textarea>
                @error('aktivitas')
    ...
    <script>
        $(document).ready(function() {
            $('#form-log-harian').on('submit', function(e) {
                ...
                $.ajax({
                    url: form.action,
                    type: 'POST', // Laravel akan handle method spoofing
                    data: formData,
                    success: function(response) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: 'Log aktivitas berhasil diperbarui',
