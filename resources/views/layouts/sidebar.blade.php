...
<aside>
    <ul class="sidebar-nav nav flex-column gap-1">
        ...
        @if (Auth::user()->role === 'admin')
            <!-- Manajemen Magang -->
            <li class="nav-item bg-light-softer">
                <div class="nav-link toggle-submenu d-flex align-items-center {{ isset($activeMenu) && $activeMenu == 'manajemenMagang' ? 'active bg-primary text-light-softer rounded' : 'text-muted' }}">
                ...
                <ul class="nav-submenu ps-5 bg-light-softer">
                    <li>
                        <a href="{{ route('admin.lowongan.index') }}" class="nav-link text-muted bg-light-softer">Lowongan Magang</a>
                    </li>
                    <li>
            ...
            <!-- Manajemen Data -->
            <li class="nav-item bg-light-softer">
                <div class="nav-link toggle-submenu d-flex align-items-center {{ isset($activeMenu) && $activeMenu == 'manajemenData' ? 'active bg-primary text-light-softer rounded' : 'text-muted' }}">
                    <i class="fas fa-database me-4"></i><b>Manajemen Data</b>
                    <i class="fas fa-caret-right ms-auto pe-2"></i>
                </div>
                <ul class="nav-submenu ps-5 bg-light-softer">
                    <li>
                        <a href="{{ route('admin.perusahaan.index') }}" class="nav-link text-muted bg-light-softer">Mitra</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.user.index') }}" class="nav-link text-muted bg-light-softer">Pengguna</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.periode.index') }}" class="nav-link text-muted bg-light-softer">Periode</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.programstudi.index') }}" class="nav-link text-muted bg-light-softer">Program Studi</a>
                    </li>
                </ul>
            </li>
