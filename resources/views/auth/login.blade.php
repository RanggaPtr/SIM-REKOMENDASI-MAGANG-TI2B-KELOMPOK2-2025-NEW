        ...
        <div class="row justify-content-center">
            <div class="login-container row g-0 shadow">
                ...
                <div class="login-left col-md-6 d-flex flex-column justify-content-center align-items-center">
                    <div id="slideshowExample" class="carousel slide w-100" data-bs-ride="carousel"
                        aria-label="Promotional slideshow">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('images/slide1.png') }}" class="d-block w-100 rounded-3"
                                    alt="Slide 1">
                                <div class="carousel-caption-bottom">
                                    ...
                                    <p>Temukan magang impian melalui magang.in, efisien dan cocok untuk semua kalangan.
                                    </p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('images/slide2.png') }}" class="d-block w-100 rounded-3"
                                    alt="Slide 2">
                                <div class="carousel-caption-bottom">
                            ...
                            <div class="carousel-item">
                                <img src="{{ asset('images/slide3.png') }}" class="d-block w-100 rounded-3"
                                    alt="Slide 3">
                                <div class="carousel-caption-bottom">
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#slideshowExample"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#slideshowExample"
                            data-bs-slide="next">
