...
class KompetensiSeeder extends Seeder
{
    public function run()
    {
        ...
        $tiProdiId = $prodiIds[0] ?? null;
        $sibProdiId = $prodiIds[1] ?? null;
        $pplProdiId = $prodiIds[2] ?? null;
