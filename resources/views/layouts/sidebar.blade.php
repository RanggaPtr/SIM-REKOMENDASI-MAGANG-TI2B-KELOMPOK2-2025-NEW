    ...
    @if (Auth::user()->role === 'admin')
        <li class="nav-item bg-light-softer">
            <div
                ...
                <i class="fas fa-briefcase me-4"></i><b>Manajemen Magang</b> <i
                    class="fas fa-caret-right ms-auto pe-2"></i>
            </div>
    ...
    @if (Auth::user()->role === 'admin')
        <li class="nav-item bg-light-softer">
            <div
                ...
                <i class="fas fa-database me-4"></i><b>Manajemen Data</b> <i
                    class="fas fa-caret-right ms-auto pe-2"></i>
            </div>
            <ul class="nav-submenu ps-5 bg-light-softer">
                <li><a href="{{ url('/admin/management-mitra') }}" class="nav-link text-muted bg-light-softer">Mitra</a>
                </li>
                ...
                <li><a href="{{ url('/admin/management-prodi') }}" class="nav-link text-muted bg-light-softer">Program
                        Studi</a></li>
            </ul>
        </li>
    @endif
    ...
    @if (Auth::user()->role === 'mahasiswa')
        ...
        <li class="nav-item bg-light-softer">
            <div class="nav-link toggle-submenu d-flex align-items-center {{ isset($activeMenu) && $activeMenu == 'aktivitasMagang' ? 'active bg-primary text-light-softer rounded' : 'text-muted' }}"
                style="padding: 10px 15px;">
                <i class="fas fa-building me-4"></i><b>Aktivitas Magang</b> <i
                    class="fas fa-caret-right ms-auto pe-2"></i>
            </div>
            <ul class="nav-submenu ps-5 bg-light-softer">
                <li><a href="{{ url('/roles/mahasiswa/log-harian') }}" class="nav-link text-muted bg-light-softer">Log
                        Harian</a></li>
            </ul>
        </li>
        <li class="nav-item bg-light-softer">
            <div class="nav-link toggle-submenu d-flex align-items-center {{ isset($activeMenu) && $activeMenu == 'sertifikasiFeedback' ? 'active bg-primary text-light-softer rounded' : 'text-muted' }}"
                style="padding: 10px 15px;">
                <i class="fas fa-file-alt me-4"></i><b>Sertifikasi & Feedback</b> <i
                    class="fas fa-caret-right ms-auto pe-2"></i>
            </div>
            <ul class="nav-submenu ps-5 bg-light-softer">
